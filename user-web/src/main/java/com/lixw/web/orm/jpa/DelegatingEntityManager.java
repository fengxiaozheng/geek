...
public class DelegatingEntityManager implements EntityManager {
    ...
    @PostConstruct
    public void init() {
        EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory(persistenceUnitName, loadProperties(persistenceLocation));
        this.entityManager = entityManagerFactory.createEntityManager();
    }

    private Map loadProperties(String persistenceLocation) {
        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        //获取资源的URL
        URL loaderResource = classLoader.getResource(persistenceLocation);
        Properties properties = new Properties();
        try {
            properties.load(loaderResource.openStream());
        } catch (IOException e) {
            e.printStackTrace();
